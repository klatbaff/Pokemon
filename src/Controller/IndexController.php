...
// symfony fasse le require de ces classes (chemin d'accès vers les classes utilisées)
use Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use Symfony\Component\Routing\Attribute\Route;


// On étends la classe AbstractController qui permet d'utiliser des fonctions
// utilitaires pour les controller (twig, etc)( ajout des fonctionnalités d'une autre classe)
